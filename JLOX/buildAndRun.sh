...
# java com.craftinginterpreters.lox.Lox ../lox-files/expr-test.lox
# java com.craftinginterpreters.lox.Lox ../lox-files/statement-test.lox
# java com.craftinginterpreters.lox.Lox ../lox-files/variables-test.lox
# java com.craftinginterpreters.lox.Lox ../lox-files/scope-test.lox
